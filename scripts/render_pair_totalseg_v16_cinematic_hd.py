"""
render_pair_totalseg_v16_cinematic_hd.py — Organic Imperfection Layer
...
v16 upgrades over v15:
  ...
  - Coat noise modulation 0.85×-1.15× + AO concavity boost (+25% coat in occluded cavities):
    touching surfaces stay wetter, exposed regions drier — contact moisture interaction
...
Run:
    blender --background --python scripts/render_pair_totalseg_v16_cinematic_hd.py -- \\
...
def main():
    ...
    print(f"\n{'='*65}")
    print(f"[v16-cinematic-hd]  subject={args.subject}  spp={args.spp}  size={args.size}px")
    print(f"Organic imperfection layer — low-freq color var + coat noise")
    print(f"{'='*65}")
    ...
    for theta in offsets:
        ...
        simple_path = out_dir / f"simple_v16_{label}.png"
        ...
        gt_path = out_dir / f"gt_v16_spp{args.spp}_{label}.png"
    ...
    grid_path = pair_out / f"{args.subject}_v16_cinematic_hd_spp{args.spp}.png"
